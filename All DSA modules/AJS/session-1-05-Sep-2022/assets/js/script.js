...
//TRAVERSAL|SEARCH-->QUERYSELECTOR(FIRST OCCURANCE in form of OBJECT) and QUERYSELECTORALL(ALL OCCURANCE in form of ARRAY)
//----->getElementsByTagName, getElementsByClass, getElementById

//CREATE ELEMENT
const captionELe=document.createElement('caption')//REFERENCE--> <caption></caption>
//STORE the REFERENCE to perform further operation

//UPDATING CONTENT or INNERHTML
...
for (let row of rowRef) {
    ...
    erialNumber.outerHTML+row.innerHTML;
    count++;
  }
